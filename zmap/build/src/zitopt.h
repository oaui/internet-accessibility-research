...
#define CMDLINE_PARSER_VERSION "Development Build. Commit 3b8c19e - Fri May 15 15:47:13 2026 +0200"
#endif

/** @brief Where the command line options are stored */
struct gengetopt_args_info
{
  char * target_ports_arg;	/**< @brief comma-delimited list of ports to scan (for TCP and UDP scans).  */
  char * target_ports_orig;	/**< @brief comma-delimited list of ports to scan (for TCP and UDP scans) original value given at command line.  */
  const char *target_ports_help; /**< @brief comma-delimited list of ports to scan (for TCP and UDP scans) help description.  */
