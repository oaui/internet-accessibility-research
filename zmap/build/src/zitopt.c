/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i /mnt/c/Users/roots/Desktop/censorship/zmap/build/src/zitopt.ggo -F /mnt/c/Users/roots/Desktop/censorship/zmap/build/src/zitopt 
...
#include "/mnt/c/Users/roots/Desktop/censorship/zmap/build/src/zitopt.h"
...
const char *gengetopt_args_info_help[] = {
  "Basic arguments:",
  "  -p, --target-ports=ports      comma-delimited list of ports to scan (for TCP\n                                  and UDP scans)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->blocklist_file_help = gengetopt_args_info_help[2] ;
  args_info->allowlist_file_help = gengetopt_args_info_help[3] ;
  ...
  args_info->disable_syslog_help = gengetopt_args_info_help[9] ;
  args_info->shards_help = gengetopt_args_info_help[11] ;
  args_info->shard_help = gengetopt_args_info_help[12] ;
  args_info->help_help = gengetopt_args_info_help[14] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "p:b:w:l:v:e:n:hV", long_options, &option_index);

      if (c == -1) break;	/* Exit from `while (1)' loop.  */

      switch (c)
        {
        case 'p':	/* comma-delimited list of ports to scan (for TCP and UDP scans).  */
